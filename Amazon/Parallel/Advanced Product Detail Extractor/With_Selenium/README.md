...
- An example output file ELECTRONICS (LAPTOPS).csv can be found which is produced as a result of running "parallel_advancedProductDetail_Extractor.py" script with the parameter blocks in the config.py file separately.
